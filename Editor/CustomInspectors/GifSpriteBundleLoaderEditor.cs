...
{
    [CustomEditor(typeof(GifSpriteBundleLoader))]
    public class GifSpriteBundleLoaderEditor : BundleLoaderEditor
    {
        ...
        {
            var obj = fullPathProperty.serializedObject.targetObject as GifSpriteBundleLoader;
            if (obj == null)
            {
                Debug.LogError($"No target object with specified type: {nameof(GifSpriteBundleLoader)}");
                return null;
            }
